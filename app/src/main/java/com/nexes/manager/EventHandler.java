...
public class EventHandler implements OnClickListener {
     ...
     */
    public EventHandler(Main main, Context context, final FileManager manager) {
        mainActivity = main;
        mContext = context;
        mFileMang = manager;
     ...
     */
    public EventHandler(Main main, Context context, final FileManager manager, String location) {
        mainActivity = main;
        mContext = context;
        mFileMang = manager;
